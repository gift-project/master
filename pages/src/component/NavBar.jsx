    ...
    <div style={{
      ...
      <div style={{
        ...
        <Link style={{
          ...
          alignItems:"center",
          margin:"1.5%",
          background:router.route == "/MyPage/[id]"?"#b2d3e1":"none"}}
          href={`/MyPage/${userLogin.UserID}`}>
          <FontAwesomeIcon 
          style={{
            width:20}} icon={faUser} /></Link>
        ...
        <Link style={{
          ...
          alignItems:"center",
          margin:"1.5%",
          background:router.route == "/GiftTree/[id]"?"#b2d3e1":"none"}} href={`/GiftTree/${userLogin.UserID}`}>
          <FontAwesomeIcon 
          style={{width:25}} icon={faGift} /></Link>

      </div>
      <span style={{
        margin: "0 20px 0 0"}}>50,000coin</span>
